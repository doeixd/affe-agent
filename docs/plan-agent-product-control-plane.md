...
**Status: Phases 0, 1 and 2 built (Phase 2 on 2026-09-22: the §11 inbox,
§8 tasks with a runner and board, and the §9 queue with leases and bounded
retries; assignment to another agent is not); Phases 3–8 not started.**
