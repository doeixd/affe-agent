...
Moved here from `STATUS.md` on 2026-08-30 (design-assessment rec 7). This is
the chronology: every dated section, finding and falsification, oldest
first, and it keeps growing -- new work appends a dated section at the end.
The short statement of what is true now is [`STATUS.md`](../STATUS.md) at
the root; edit the line there that a change affects. The numbers quoted in
older sections were true when written and are not maintained.

---

# Implementation status — `0.0.1` (as first written)
