 ...
 * over `WorkbenchApi`, on one port, both behind the same bearer tokens.
 *
...
/** The served agent, named in each person's registry once, so their conversations have an agent to record. */
