...
export interface Eval<Tools extends Record<string, Tool.Any>, E, R, TE, TR, Value = string, Input = Prompt.RawInput> {
  readonly name: string
...
export const defineEval = <Tools extends Record<string, Tool.Any>, E, R, TE = never, TR = never, Value = string, Input = Prompt.RawInput>(
 ...
 */
export const run = <Tools extends Record<string, Tool.Any>, E, R, TE, TR, Value = string, Input = Prompt.RawInput>(
  ...
  Effect.scoped(
    Effect.gen(function* () {
      ...
      const t: EvalContext<Tools, E, Value, Input> = {
        send: (input, options) =>
          AgentSession.prompt<Tools, E, Value, Input>(session, input, options ?? {}).pipe(
...
export const runAll = <Tools extends Record<string, Tool.Any>, E, R, TE, TR, Value = string, Input = Prompt.RawInput>(
